"""
Dataset classes for the Concatenation Multimodal VAE.

Identical split logic to detection.svd_unet_vae.dataset, but uses the
multimodal ConcatTransform that returns (input_5ch, target_5ch).
"""
import random
...
class RealTrainDataset(Dataset):
    """Real images, train/val/test split — returns (input_5ch, target_5ch)."""
